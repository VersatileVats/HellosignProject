                        ...
                        <div class="card shadow mb-3">
                            <div class="card-header py-2">
                                ...
                                <?php
                                        ...
                                        $check_query = "SELECT signatureID from r_hospitals WHERE r_id = '$answer[r_id]'";
                                        $result_check_query = mysqli_query($connect, $search_referral_query) or die(mysqli_error($connect));   
                                        $checkResult = mysqli_fetch_array($result_check_query);
                                        if($checkResult['signatureID'] == "") {
                                ?>  
                                    <!--delReferral.php-->
                                    <a href="utilities/delReferral.php?r_id=<?php echo $answer[r_id] ?>" style="display: inline-block; float: right" class="mx-2" >
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="card shadow mb-3">
                                        ...
                                        <div class="card-body">
                                            <form action="utilities/details_extraction.php?p_id=<?php echo $p_id ?>" method="post">
                                                <div class="row">
                                                    <div class="col">
                                                ...
                                                <div class="col" id="options_available" style="display: none">
                                                        <div class="mb-3">
                                                            ...
                                                            <div class="btn-group d-block" >
                                                                <select name="select_hospital" type="button" class="btn border border-primary dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false" style="width:100%" id="append_options" required>
                                                                    Select from below 
