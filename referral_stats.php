                        ...
                        <div class="col">
                            <div class="row">
                                ...
                                <?php
                                    ...
                                    ?>
                            <div class="flip-card col-lg-3 mb-4">
                                <div class="flip-card-inner">
                                        <?php
                                            if($row['status'] == 'accept') {
                                        ?>
                                            <div class="flip-card-front card textwhite bg-success text-white shadow py-3">
                                        <?php
                                            } elseif($row['status'] == 'reject') {
                                        ?>
                                            <div class="flip-card-front card textwhite bg-danger text-white shadow">
                                        <?php
                                            } else {
                                        ?>
                                            <div class="flip-card-front card textwhite bg-warning text-white shadow py-3">
                                        <?php
                                            }
                                        ?>
