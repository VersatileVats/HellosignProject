...
<body id="page-top" data-bs-spy="scroll" data-bs-target="#mainNav" data-bs-offset="57" style="user-select:none">
    ...
    <header class="text-center text-white d-flex masthead"
        style="background-image: url('assets/img/header.jpg');position:relative; height: 100vh">
            ...
            <div class="container text-center">
                ...
                <div class="row">
                    ...
                    <div class="col sm-6 mb-0">
                        ...
                        <p>Fetch details of any country</p>
                            <div class="row">
                                <div class="col-6">
    ...
    <script>
        document.getElementById('fetchData').addEventListener('click', async()=> {
                ...
                xhr.onload = function () {
                    ...
                    document.getElementById('total_cases').style.display = "none";
                    document.getElementById('active_cases').style.display = "none";
                    document.getElementById('total_deaths').style.display = "none";
                    document.getElementById('total_tests').style.display = "none";
                    
                    if(arr[0] != "") {
                        document.getElementById('population').style.display = "block";
                        document.getElementById('population').innerHTML =  "🟡 <u>Population</u> : "+arr[0];     
                    } if (arr[1] != "") {
                        document.getElementById('total_cases').style.display = "block";
                        document.getElementById('total_cases').innerHTML =  "🟡 <u>Total Cases</u> : "+arr[1];     
                    } if (arr[2] != "") {
                        document.getElementById('active_cases').style.display = "block";
                        document.getElementById('active_cases').innerHTML =  "🟡 <u>Active Cases</u> : "+arr[2];    
                    } if (arr[3] != "") {
                        document.getElementById('total_deaths').style.display = "block";
                        document.getElementById('total_deaths').innerHTML =  "🟡 <u>Total deaths</u> : "+arr[3];    
                    } if (arr[4] != "") {
                        document.getElementById('total_tests').style.display = "block";
