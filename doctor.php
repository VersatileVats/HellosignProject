            ...
            <div id="content">
                <nav class="navbar navbar-light navbar-expand bg-white shadow mb-4 topbar static-top">
                    <div class="container-fluid"><button class="btn btn-link d-md-none rounded-circle me-3" id="sidebarToggleTop" type="button"><i class="fas fa-bars"></i></button>
                        ...
                        <h3 onclick="window.location.href='doctor.php'" class="text-dark mb-0" style="cursor: pointer; font-weight: bold">Dashboard</h3>
                            ...
                            <li class="nav-item dropdown no-arrow">
                                <div class="nav-item dropdown no-arrow"><a class="dropdown-toggle nav-link" aria-expanded="false" data-bs-toggle="dropdown" href="#"><span class="d-none d-lg-inline me-2 text-gray-600 small"><?php echo($_SESSION['name']) ?></span><img class="border rounded-circle img-profile" src="https://img.icons8.com/ios-glyphs/30/000000/test-account.png"/></a>
                                    <div class="dropdown-menu shadow dropdown-menu-end animated--grow-in">
                                        <div class=""></div><a class="dropdown-item" href="logout.php"><i class="fas fa-sign-out-alt fa-sm fa-fw me-2 text-gray-400"></i>&nbsp;Logout</a>
                                    </div>
                                </div>
                            </li>
                        </ul>
                ...
                <div class="container container-fluid">
                    <h4 style="width: 100%; text-align: center">Your appointments are as follows: </h4>
                    <p style="width: 100%; text-align: center">The page refreshes in every 30 seconds</p>
                    <?php
                            ...
                            <div class="table-responsive table mt-2" id="options_available" role="grid" aria-describedby="dataTable_info">
                                   <table class="table my-0">
                                        ...
                                        <div class="d-flex justify-content-center">
                                            <button onclick="window.location.href='utilities/deleteAppoint.php?p_id=<?php echo $p_id ?>&d_id=<?php echo $_SESSION['id'] ?>'" class="mt-2 btn btn-outline-primary " style="font-weight: bold; margin: 5px 0px">Discharge</button>
                                            
                                            <?php
                                                
                                                $query = "SELECT id,signed from appointment WHERE d_id = '$_SESSION[id]' && status = 'accepted' ";
                                                $result_query = mysqli_query($connect, $query) or die(mysqli_error($connect)); 
                                                $row = mysqli_fetch_array($result_query);
                                                if($row['signed'] == 'true') {
                                            ?>
                                            <button onclick="window.location.href='utilities/gqRecords/<?php echo $row['id'] ?>.pdf'" class="mt-2 btn btn-outline-primary " style="font-weight: bold; margin: 5px 5px">View GQ</button>
                                            <?php } ?>
                                        </div>
                            </div>
